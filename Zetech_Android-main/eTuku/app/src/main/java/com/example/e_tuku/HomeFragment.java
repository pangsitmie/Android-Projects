...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        categoryRecView = v.findViewById(R.id.categoryRecView);
        adapter = new CategoryRecViewAdapter(getActivity());

        categoryRecView.setAdapter(adapter);
        categoryRecView.setLayoutManager(new GridLayoutManager(getActivity(), 3));
